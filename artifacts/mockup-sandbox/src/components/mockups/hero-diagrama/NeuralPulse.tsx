    ...
    <div className="relative w-full h-[580px] bg-[#020817] overflow-hidden flex items-center justify-center font-sans">
      ...
      >
        ...
        <path
          ...
          className="animate-[flow_3.5s_linear_infinite_0.2s]"
          filter="url(#glow)"
        />

        {/* Tool 2 */}
        <path
          d="M 35% 50% C 45% 50%, 50% 35%, 65% 35%"
          stroke="url(#line-gradient-2)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.2s_linear_infinite_0.5s]"
          filter="url(#glow)"
        />
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3s_linear_infinite_0.8s]"
          filter="url(#glow)"
        />

        {/* Tool 4 */}
        <path
          d="M 35% 50% C 45% 50%, 50% 65%, 65% 65%"
          stroke="url(#line-gradient-2)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.4s_linear_infinite_1.1s]"
          filter="url(#glow)"
        />

        {/* Tool 5 */}
        <path
          d="M 35% 50% C 45% 50%, 50% 80%, 65% 80%"
          stroke="url(#line-gradient-2)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.6s_linear_infinite_1.4s]"
          filter="url(#glow)"
        />
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.5s_linear_infinite_1s]"
          filter="url(#glow)"
        />
        
        {/* Tool 2 */}
        <path
          d="M 65% 35% C 75% 35%, 80% 50%, 85% 50%"
          stroke="url(#line-gradient-3)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.2s_linear_infinite_1.3s]"
          filter="url(#glow)"
        />
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3s_linear_infinite_1.6s]"
          filter="url(#glow)"
        />

        {/* Tool 4 */}
        <path
          d="M 65% 65% C 75% 65%, 80% 50%, 85% 50%"
          stroke="url(#line-gradient-3)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.4s_linear_infinite_1.9s]"
          filter="url(#glow)"
        />

        {/* Tool 5 */}
        <path
          d="M 65% 80% C 75% 80%, 80% 50%, 85% 50%"
          stroke="url(#line-gradient-3)"
          strokeWidth="1.5"
          fill="none"
          className="opacity-40"
        ...
        <path
          ...
          fill="none"
          strokeDasharray="15 150"
          className="animate-[flow_3.6s_linear_infinite_2.2s]"
          filter="url(#glow)"
        />
      </svg>
